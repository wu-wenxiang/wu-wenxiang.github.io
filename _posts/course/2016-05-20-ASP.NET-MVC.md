...
- Add Controller
	...
	![AddMovieController1.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-AddMovieController1.png)
	![AddMovieController2.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-AddMovieController2.png)
	![AddMovieController3.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-AddMovieController3.png)

- 现在我们就可以通过WebPage操作Movie模型了

	![ShowMovieEditPage.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-ShowMovieEditPage.png)

### LocalDB

- 我们可以查看AppData里的本地数据库文件

	![ShowAppData1.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-ShowAppData1.png)
	![ShowAppData2.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-ShowAppData2.png)

- 在Server Explorer里可以打开MovieDBContext

	![VSDBContext1.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext1.png)

- 点击左边的小三角，会自动连接上

	![VSDBContext2.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext2.png)

- 然后可以查看表结构和查询数据

	![VSDBContext3.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext3.png)
	![VSDBContext4.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext4.png)
	![VSDBContext5.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext5.png)
	![VSDBContext6.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext6.png)
	![VSDBContext7.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext7.png)
	![VSDBContext8.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-VSDBContext8.png)
...
- IIS-AppPool账号对LocalDB文件需要有写权限
	...
	![SetPermission1.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-SetPermission1.png)
	![SetPermission2.png](http://7xudfs.com1.z0.glb.clouddn.com/4d7ac251b31c453382216147ee032bd5-SetPermission2.png)

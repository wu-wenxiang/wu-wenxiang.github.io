...
1. [部署] 如何使用Anaconda管理Python包？[清华源](https://mirror.tuna.tsinghua.edu.cn/help/anaconda/)
...
1. [部署] Spyder的使用，在tools->preferences->IPython console->advanced Settings 下面，把User the greedy completer 勾选上。自动补全用Tab，批量注释用Ctrl + 1: 注释/反注释，Tab/Shift + Tab: 代码缩进/反缩进

...
- 根据微软的统计分析，对于IE的抱怨主要集中在如下几个方面：
	- IE8对HTML5支持较差。
		...
		- 其实，也要怪XP/Win7作为操作系统来说太成功，太受欢迎，产品的生命线太长，相当大比例的用户一直使用IE8是因为他们一直在使用XP系统，或者他们使用Win7——同时拒绝了微软的IE升级建议。
	- IE的F12调试功能不够强大
	- IE性能不够快
	- IE容易被各种插件绑架
...
## 企业模式
- DocMode
	- [Refer](https://msdn.microsoft.com/en-us/library/ff406036(v=vs.85).aspx)
	- F12 > EMIE > DocType MetaTag > Compatiable View

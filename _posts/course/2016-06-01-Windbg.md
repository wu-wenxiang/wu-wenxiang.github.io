...
- Analysis
	...
	- Analyze Dump
		...
		- Check callstack
				...
				00 000000c8`643ae478 00007ffd`4a901118 ntdll!ZwWaitForSingleObject(void)+0xa
				01 000000c8`643ae480 00007ffd`4d505f4b KERNELBASE!WaitForSingleObjectEx(void * hHandle = 0x00000000`000002bc, unsigned long dwMilliseconds = 0xffffffff, int bAlertable = 0n0)+0x94
				02 000000c8`643ae520 00007ffd`4d505c2d sechost!ScSendResponseReceiveControls(void * hServiceChannel = 0x000000c8`6453be20, void * hCompletionEvent = 0x00000000`000002bc, unsigned long dwDispatcherStatus = 0, unsigned long dwHandlerRetVal = 0, unsigned int64 ullControlSequence = 0xcb13d, unsigned long cServiceTags = 0, unsigned long * pdwServiceTags = 0x00000000`00000000, wchar_t ** ppszServiceName = 0x000000c8`643ae6b0, struct _SC_CONTROL_MESSAGE_OUT_PARAMS * pScControlParams = 0x000000c8`643ae6d8)+0x151
				03 000000c8`643ae660 00007ffd`4d505ff9 sechost!ScDispatcherLoop(void ** phServiceChannel = 0x000000c8`643ae7b8)+0x13b
				04 000000c8`643ae770 00007ffd`415a8597 sechost!StartServiceCtrlDispatcherW(struct _SERVICE_TABLE_ENTRYW * lpServiceStartTable = 0x00007ffd`41585e10)+0x50
				05 000000c8`643ae7b0 00007ffd`415ab6ae System_ServiceProcess_ni!DomainBoundILStubClass.IL_STUB_PInvoke(<HRESULT 0x80004001>)+0x77
				...
				08 000000c8`643ae910 00007ffd`4376361c clr!CallDescrWorkerInternal(void)+0x83
				09 000000c8`643ae950 00007ffd`437644d3 clr!CallDescrWorkerWithHandler(struct CallDescrData * pCallDescrData = 0x000000c8`643aeaa0, int fCriticalCall = 0n0)+0x4e
				0a 000000c8`643ae990 00007ffd`438bf75a clr!MethodDescCallSite::CallTargetWorker(unsigned int64 * pArguments = 0x00000000`00000000)+0x2af
				0b (Inline Function) --------`-------- clr!MethodDescCallSite::Call+0x1c
				...
				0e 000000c8`643aeff0 00007ffd`438bea02 clr!SystemDomain::ExecuteMainMethod(struct HINSTANCE__ * hMod = <Value unavailable error>)+0x6b9
				0f 000000c8`643af630 00007ffd`438be9b2 clr!ExecuteEXE(struct HINSTANCE__ * hMod = 0x000000c8`64260000)+0x43
				10 000000c8`643af6a0 00007ffd`438be8f4 clr!_CorExeMainInternal(void)+0xb2
				11 000000c8`643af730 00007ffd`440d6cf5 clr!_CorExeMain(void)+0x14
				12 000000c8`643af770 00007ffd`4417ea5b mscoreei!_CorExeMain(void)+0xe0
				13 (Inline Function) --------`-------- mscoree!ShellShim__CorExeMain+0xc7
				14 000000c8`643af7c0 00007ffd`4c9a13d2 mscoree!_CorExeMain_Exported(void)+0xcb
				15 000000c8`643af7f0 00007ffd`4d5854e4 kernel32!BaseThreadInitThunk(unsigned long RunProcessInit = <Value unavailable error>, <function> * StartAddress = 0x00007ffd`4417e990, void * Argument = 0x00007ff5`ff7d8000)+0x22
				16 000000c8`643af820 00000000`00000000 ntdll!RtlUserThreadStart(<function> * StartAddress = 0x00007ffd`4417e990, void * Argument = 0x00007ff5`ff7d8000)+0x34
				...
				10 000000c8`7ebae280 00007ffd`426acfed mscorlib_ni!System.Threading.ExecutionContext.Run(<HRESULT 0x80004001>)+0x17
				11 000000c8`7ebae2b0 00007ffd`426b4232 mscorlib_ni!System.Runtime.CompilerServices.AsyncMethodBuilderCore+MoveNextRunner.Run(<HRESULT 0x80004001>)+0x6d
				12 000000c8`7ebae300 00007ffd`4268db68 mscorlib_ni!System.Threading.Tasks.AwaitTaskContinuation.RunOrScheduleAction(<HRESULT 0x80004001>)+0x62
				13 000000c8`7ebae350 00007ffd`426b30f4 mscorlib_ni!System.Threading.Tasks.Task.FinishContinuations(<HRESULT 0x80004001>)+0x458
				14 000000c8`7ebae3e0 00007ffd`426abafd mscorlib_ni!System.Threading.Tasks.Task`1[[System.__Canon, mscorlib]].TrySetResult(<HRESULT 0x80004001>)+0x25b14
				15 000000c8`7ebae410 00007ffd`426aba16 mscorlib_ni!System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1[[System.Boolean, mscorlib]].SetResult(<HRESULT 0x80004001>)+0x268d
				16 000000c8`7ebae450 00007ffc`e49e621b mscorlib_ni!System.Runtime.CompilerServices.AsyncTaskMethodBuilder.SetResult(<HRESULT 0x80004001>)+0x46
				17 000000c8`7ebae490 00007ffd`42622490 AService!AOrg.WinEng.MyApps.Service.AgentNotifier+<UpdateApplicationName>d__40.MoveNext(<HRESULT 0x80004001>)+0x2cb
				18 000000c8`7ebae580 00007ffd`42622327 mscorlib_ni!System.Threading.ExecutionContext.RunInternal(<HRESULT 0x80004001>)+0x160
				19 000000c8`7ebae650 00007ffd`426acfed mscorlib_ni!System.Threading.ExecutionContext.Run(<HRESULT 0x80004001>)+0x17
				1a 000000c8`7ebae680 00007ffd`426b4232 mscorlib_ni!System.Runtime.CompilerServices.AsyncMethodBuilderCore+MoveNextRunner.Run(<HRESULT 0x80004001>)+0x6d
				1b 000000c8`7ebae6d0 00007ffd`4268db68 mscorlib_ni!System.Threading.Tasks.AwaitTaskContinuation.RunOrScheduleAction(<HRESULT 0x80004001>)+0x62
				1c 000000c8`7ebae720 00007ffd`426b30f4 mscorlib_ni!System.Threading.Tasks.Task.FinishContinuations(<HRESULT 0x80004001>)+0x458
				1d 000000c8`7ebae7b0 00007ffd`426abafd mscorlib_ni!System.Threading.Tasks.Task`1[[System.__Canon, mscorlib]].TrySetResult(<HRESULT 0x80004001>)+0x25b14
				1e 000000c8`7ebae7e0 00007ffd`426aba16 mscorlib_ni!System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1[[System.Boolean, mscorlib]].SetResult(<HRESULT 0x80004001>)+0x268d
				1f 000000c8`7ebae820 00007ffc`e49e33cf mscorlib_ni!System.Runtime.CompilerServices.AsyncTaskMethodBuilder.SetResult(<HRESULT 0x80004001>)+0x46
				20 000000c8`7ebae860 00007ffd`42622490 AService!AOrg.WinEng.MyApps.Service.AgentNotifier+<PromptAsync>d__34.MoveNext(<HRESULT 0x80004001>)+0x21f
				21 000000c8`7ebae910 00007ffd`42622327 mscorlib_ni!System.Threading.ExecutionContext.RunInternal(<HRESULT 0x80004001>)+0x160
				22 000000c8`7ebae9e0 00007ffd`426acfed mscorlib_ni!System.Threading.ExecutionContext.Run(<HRESULT 0x80004001>)+0x17
				23 000000c8`7ebaea10 00007ffd`426b4232 mscorlib_ni!System.Runtime.CompilerServices.AsyncMethodBuilderCore+MoveNextRunner.Run(<HRESULT 0x80004001>)+0x6d
				...
				2c 000000c8`7ebaedc0 00007ffd`42622327 mscorlib_ni!System.Threading.ExecutionContext.RunInternal(<HRESULT 0x80004001>)+0x160
				2d 000000c8`7ebaee90 00007ffd`426ab1bd mscorlib_ni!System.Threading.ExecutionContext.Run(<HRESULT 0x80004001>)+0x17
				2e 000000c8`7ebaeec0 00007ffd`426aa888 mscorlib_ni!System.Threading.Tasks.Task.ExecuteWithThreadLocal(<HRESULT 0x80004001>)+0x21d
				2f 000000c8`7ebaef70 00007ffd`42631f70 mscorlib_ni!System.Threading.Tasks.Task.ExecuteEntry(<HRESULT 0x80004001>)+0x98
				30 000000c8`7ebaefb0 00007ffd`43763753 mscorlib_ni!System.Threading.ThreadPoolWorkQueue.Dispatch(<HRESULT 0x80004001>)+0x160
				31 000000c8`7ebaf050 00007ffd`4376361c clr!CallDescrWorkerInternal(void)+0x83
				32 000000c8`7ebaf090 00007ffd`437644d3 clr!CallDescrWorkerWithHandler(struct CallDescrData * pCallDescrData = 0x000000c8`7ebaf1e0, int fCriticalCall = 0n0)+0x4e
				33 000000c8`7ebaf0d0 00007ffd`4376b73d clr!MethodDescCallSite::CallTargetWorker(unsigned int64 * pArguments = 0x00000000`00000000)+0x2af
				34 (Inline Function) --------`-------- clr!MethodDescCallSite::Call_RetBool+0xc
				35 000000c8`7ebaf260 00007ffd`43766810 clr!QueueUserWorkItemManagedCallback(void * pArg = 0x000000c8`7ebaf7f0)+0x2a
				36 000000c8`7ebaf350 00007ffd`437667c0 clr!ManagedThreadBase_DispatchInner(struct ManagedThreadCallState * pCallState = 0x000000c8`7ebaf540)+0x29
				37 000000c8`7ebaf390 00007ffd`43766705 clr!ManagedThreadBase_DispatchMiddle(struct ManagedThreadCallState * pCallState = 0x000000c8`7ebaf540)+0x6c
				38 000000c8`7ebaf490 00007ffd`43766947 clr!ManagedThreadBase_DispatchOuter(struct ManagedThreadCallState * pCallState = 0x000000c8`7ebaf540)+0x75
				39 000000c8`7ebaf520 00007ffd`4376b6a2 clr!ManagedThreadBase_FullTransitionWithAD(struct ADID pAppDomain = struct ADID, <function> * pTarget = <Value unavailable error>, void * args = <Value unavailable error>, UnhandledExceptionLocation filterType = <Value unavailable error>)+0x2f
				3a (Inline Function) --------`-------- clr!ManagedThreadBase::ThreadPool+0x15
				3b 000000c8`7ebaf580 00007ffd`437658ba clr!ManagedPerAppDomainTPCount::DispatchWorkItem(bool * foundWork = 0x000000c8`7ebaf7e8, bool * wasNotRecalled = 0x000000c8`7ebaf7f0)+0x11c
				3c 000000c8`7ebaf710 00007ffd`437657da clr!ThreadpoolMgr::ExecuteWorkRequest(bool * foundWork = 0x000000c8`7ebaf7e8, bool * wasNotRecalled = 0x000000c8`7ebaf7f0)+0x64
				3d 000000c8`7ebaf740 00007ffd`43783e1e clr!ThreadpoolMgr::WorkerThreadStart(void * lpArgs = 0x00000000`00000000)+0x3b5
				3e 000000c8`7ebaf7e0 00007ffd`4c9a13d2 clr!Thread::intermediateThreadProc(void * arg = <Value unavailable error>)+0x7d
				3f 000000c8`7ebafba0 00007ffd`4d5854e4 kernel32!BaseThreadInitThunk(unsigned long RunProcessInit = <Value unavailable error>, <function> * StartAddress = 0x00007ffd`43783da8, void * Argument = 0x000000c8`7da4f5b0)+0x22
				40 000000c8`7ebafbd0 00000000`00000000 ntdll!RtlUserThreadStart(<function> * StartAddress = 0x00007ffd`43783da8, void * Argument = 0x000000c8`7da4f5b0)+0x34
				...
				0c 000000c8`00fde8b0 00007ffd`4ac42885 shell32!CBindAndInvokeStaticVerb::_DoCommand(struct IExecuteCommand * pxc = 0x000000c8`7e335270, struct IShellItemArray * psia = <Value unavailable error>, bool fEnableSwitchIfNeeded = false)+0x123
				0d 000000c8`00fde930 00007ffd`4ac45212 shell32!CBindAndInvokeStaticVerb::_TryCreateProcessDdeHandler(unsigned long indexItem = <Value unavailable error>)+0x4d
				0e 000000c8`00fde960 00007ffd`4ac41d2a shell32!CBindAndInvokeStaticVerb::Execute(void)+0xf7
				0f 000000c8`00fdea10 00007ffd`4ac408e5 shell32!CShellExecute::_ExecuteAssoc(struct IAssociationArray * paa = <Value unavailable error>)+0x11a
				10 000000c8`00fdea80 00007ffd`4ac40b84 shell32!CShellExecute::_DoExecute(void)+0xd5
				11 000000c8`00fdeae0 00007ffd`4ac40ac4 shell32!CShellExecute::ExecuteNormal(struct _SHELLEXECUTEINFOW * pei = 0x000000c8`6542ac90)+0x94
				12 000000c8`00fdeb10 00007ffd`4ac40a39 shell32!ShellExecuteNormal(struct _SHELLEXECUTEINFOW * pei = 0x000000c8`6542ac90)+0x4c
				13 000000c8`00fdeb40 00007ffd`418be6aa shell32!ShellExecuteExW(struct _SHELLEXECUTEINFOW * pei = 0x000000c8`6542ac90)+0x35
				14 000000c8`00fdeb70 00007ffd`41813b41 System_ni!DomainBoundILStubClass.IL_STUB_PInvoke(<HRESULT 0x80004001>)+0x8a
				...
				16 000000c8`00fdec60 00007ffd`42622327 mscorlib_ni!System.Threading.ExecutionContext.RunInternal(<HRESULT 0x80004001>)+0x160
				17 000000c8`00fded30 00007ffd`426222e2 mscorlib_ni!System.Threading.ExecutionContext.Run(<HRESULT 0x80004001>)+0x17
				18 000000c8`00fded60 00007ffd`426c2362 mscorlib_ni!System.Threading.ExecutionContext.Run(<HRESULT 0x80004001>)+0x52
				19 000000c8`00fdedb0 00007ffd`43763753 mscorlib_ni!System.Threading.ThreadHelper.ThreadStart(<HRESULT 0x80004001>)+0x52
				1a 000000c8`00fdedf0 00007ffd`4376361c clr!CallDescrWorkerInternal(void)+0x83
				1b 000000c8`00fdee30 00007ffd`437644d3 clr!CallDescrWorkerWithHandler(struct CallDescrData * pCallDescrData = 0x000000c8`00fdef80, int fCriticalCall = 0n0)+0x4e
				1c 000000c8`00fdee70 00007ffd`43c10fb8 clr!MethodDescCallSite::CallTargetWorker(unsigned int64 * pArguments = 0x00000000`00000001)+0x2af
				1d (Inline Function) --------`-------- clr!MethodDescCallSite::Call+0xc
				1e 000000c8`00fdf000 00007ffd`43766810 clr!ThreadNative::KickOffThread_Worker(void * ptr = <Value unavailable error>)+0x17c
				1f 000000c8`00fdf260 00007ffd`437667c0 clr!ManagedThreadBase_DispatchInner(struct ManagedThreadCallState * pCallState = 0x000000c8`00fdf450)+0x29
				20 000000c8`00fdf2a0 00007ffd`43766705 clr!ManagedThreadBase_DispatchMiddle(struct ManagedThreadCallState * pCallState = 0x000000c8`00fdf450)+0x6c
				21 000000c8`00fdf3a0 00007ffd`43766947 clr!ManagedThreadBase_DispatchOuter(struct ManagedThreadCallState * pCallState = 0x000000c8`00fdf450)+0x75
				22 000000c8`00fdf430 00007ffd`43c10bd3 clr!ManagedThreadBase_FullTransitionWithAD(struct ADID pAppDomain = struct ADID, <function> * pTarget = <Value unavailable error>, void * args = <Value unavailable error>, UnhandledExceptionLocation filterType = <Value unavailable error>)+0x2f
				23 (Inline Function) --------`-------- clr!ManagedThreadBase::KickOff+0x20
				24 000000c8`00fdf490 00007ffd`43783e1e clr!ThreadNative::KickOffThread(void * pass = 0x000000c8`00331b30)+0x16f
				25 000000c8`00fdf560 00007ffd`4c9a13d2 clr!Thread::intermediateThreadProc(void * arg = <Value unavailable error>)+0x7d
				26 000000c8`00fdff20 00007ffd`4d5854e4 kernel32!BaseThreadInitThunk(unsigned long RunProcessInit = <Value unavailable error>, <function> * StartAddress = 0x00007ffd`43783da8, void * Argument = 0x000000c8`00350010)+0x22
				27 000000c8`00fdff50 00000000`00000000 ntdll!RtlUserThreadStart(<function> * StartAddress = 0x00007ffd`43783da8, void * Argument = 0x000000c8`00350010)+0x34
	...
	- In thread 15, we could find:
		...
		- there was a DialogBox popup, which is not correct, since DialogBox in background will hang the service process.
				...
				pwnd    = 0x000000c8645be0b0
					...
					hImc               0x00000000
					bFullScreen        0y0
					hModule            0x7ffd2f0e0000
					pActCtx            0xc800457318
					zbid               0n1
	...
	- Check thread 7, it wait for thread join()
		- Callstack
				...
				000000c8`7d4d0000 000000c8`7d504000   Common   C (no symbols)           
				    ...
				    Image path: Common.dll
				    Image name: Common.dll
				    Browse all global symbols  functions  data
				    Using CLR debugging support for all symbols
				    Has CLR image header, track-debug-data flag not set
				    Timestamp:        Tue Jun 21 13:14:54 2016 (5768CD4E)
				    CheckSum:         00000000
				    ImageSize:        00034000
				    File version:     6.0.6016.23847
				    Product version:  6.0.6016.23847
				    ...
				    ProductName:      MyInstaller 6.0
				    InternalName:     Common.dll
				    OriginalFilename: Common.dll
				    ProductVersion:   6.0.6016.23847
				    FileVersion:      6.0.6016.23847
				    FileDescription:  Common
				    LegalCopyright:   Copyright © Aorg 2011
				    LegalTrademarks:  
				    Comments:  

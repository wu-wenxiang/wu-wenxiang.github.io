...
1. [数字] **整数的除法运算和整除运算是如何实现的？**Python2和3有何不同？我们应该怎么写兼容性较好的代码？
1. [数字] **Python如何处理进制转换（整数与字符串的互相转换）？**
1. [数字] **应如何判断两个浮点数是否相等？**
1. [数字] **浮点数精度控制(`round`)和精度显示(`%.2f`)各自应用在什么场景？应如何操作？**
...
1. [字符] **如何实现字符串的乘法和加法？**
1. [字符] **如何操作字符串切片？负index、单冒号、左开右闭、边界缺省None、双冒号、负步长**
1. [字符] **如何实现子字符串的替换、查找？**
1. [字符] 如何实现字符串的大小写转换，以及将字符串首字母或者其中每个单词首字母变为大写？
1. [字符] **如何实现字符串的切割和粘合？**
1. [字符] **如何移除字符串两端的空白？**
1. [字符] **如何获取字符串的长度？**
...
1. [序列] **序列的通用运算有哪些？`in/not-in`, `for`, `+/*`, `slice`, `len`, `min`, `max`, `sorted`**
1. [序列] **如何理解列表对象的可变性与元组对象的不可变性？**
1. [序列] 生成器对象和列表对象的区别是什么？
1. [序列] **列表对象的常见运算有哪些？序列元素的添加，排序，访问，反序，移除，修改，zip组合，遍历**
1. [序列] **什么是列表解析？**
...
1. [散列] **集合运算有哪些？**
1. [散列] 如何初始化一个字典？
1. [散列] **字典的常用方法和常见运算有哪些？散列元素的添加，访问，排序，移除，修改，遍历，存在判断**
...
1. [模块] **import语法的变化和最佳实践是怎样的（避免`from x import *`）？为什么import应该以module为单位？**
1. [模块] reload的应用场景是什么？

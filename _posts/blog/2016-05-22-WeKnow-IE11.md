...
1. IE的蜕变
	...
	- 前端开发工程师：IE8对HTML5支持较差，IE的F12调试功能也不够强大。
...
1. [Create an all-inclusive deployment package for Internet Explorer 11](https://support.microsoft.com/en-us/kb/3061428)
	
	官方blog中给出的方案是bat脚本，这是比较常见的做法。如果您希望做成一个更便捷的AllInOne的exe可执行文件，可以自己做一个，或者开Case请微软的Support部门帮您定制。

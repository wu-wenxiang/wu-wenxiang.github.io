...
- 通过WSUS部署Internet Explorer 11
	...
	1. Windows Server Update Services (WSUS) 可以协助您在本地WSUS服务器上完成微软产品更新的单次下载和缓存，随后您可以配置您的计算机以从该本地WSUS服务器上获得并安装更新，而不是通过Windows Update。

	1. 将Internet Explorer 11更新从Windows Update导入到WSUS
	...
	1. 在WSUS中签署安装Internet Explorer 11
